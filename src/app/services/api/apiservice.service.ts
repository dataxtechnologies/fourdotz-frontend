...
export class ApiserviceService {
  ...
  public fetchAssociationlist<T>( ): Observable<T> {
  ...
  public fetchAssociationlistbyId<T>(data : any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.fetchAssociationlist
      }?user_id=${data}`;
  ...
  public listpayoutrequestinSA<T>( user_id: any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.listpayoutrequestinSA}?super_admin_id=${user_id}`;
  ...
  public listpayoutrequestinAssociation<T>( user_id: any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.listpayoutrequestinAssociation}?user_id=${user_id}`;
  ...
  public payoutcardDetailsinAssociation<T>(): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.payoutcardDetailsinAssociation}`;
  ...
  public createpayoutrequestinAssociation<T>(payload: any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.createpayoutrequestinAssociation
      }`;
  ...
  public payoutcardDetailsinAssociationbyAssociationID<T>(userId : any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.payoutcardDetailsinAssociation}?hoa_admin=${userId}`;
  ...
  public updatepayoutrequeststatus<T>(formData: FormData): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.updatepayoutrequeststatus
      }`;
  ...
  public contactusSubmit<T>(payload: any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.contactusSubmit
      }`;
  ...
  public listAllRequestinSite<T>(type : any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.listAllRequestinSite}?type=${type}`;
  ...
  public listAllRequestinSiteinUsers<T>(type : any, user_id : any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.listAllRequestinSite}?type=${type}&user_id=${user_id}`;
  ...
  public listAllRequestinSiteinAssociation<T>(type : any, user_id : any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.listAllRequestinSite}?type=${type}&hoa_admin_id=${user_id}`;
  ...
  public listAllRequestinSiteinSA<T>(type : any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.listAllRequestinSite}?type=${type}`;
  ...
  public createNewSupportTicket<T>(payload: any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.createNewSupportTicket
      }`;
  ...
  public UpdateTicketData<T>(payload: any): Observable<T> {
    const serviceURL = `${this.urlHelper.getAPIURL()}${this.envUrl.UpdateTicketData
      }`;
