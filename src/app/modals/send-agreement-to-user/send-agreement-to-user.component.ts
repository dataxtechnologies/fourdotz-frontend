...
@Component({
  selector: 'app-send-agreement-to-user',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './send-agreement-to-user.component.html',
  styleUrl: './send-agreement-to-user.component.css',
})
export class SendAgreementToUserComponent implements OnInit {
...
onSearchChange(event: Event) {
  ...
  submit() {
    ...
    const payload = {
      ...
      agreement_gen_user_id: this.selectedProperty.owner_user_id,
    };
