...
@Component({
  selector: 'app-view-saved-template',
  imports: [CommonModule, FormsModule],
  templateUrl: './view-saved-template.component.html',
  styleUrl: './view-saved-template.component.css'
})
export class ViewSavedTemplateComponent {
/* ===== TEMPLATE ===== */
  template = {
