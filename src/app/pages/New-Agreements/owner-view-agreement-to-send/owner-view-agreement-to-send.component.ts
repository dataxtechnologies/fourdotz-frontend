...
@Component({
  selector: 'app-owner-view-agreement-to-send',
  imports: [CommonModule, FormsModule],
  templateUrl: './owner-view-agreement-to-send.component.html',
  styleUrl: './owner-view-agreement-to-send.component.css'
})
export class OwnerViewAgreementToSendComponent {
template: any = null;
