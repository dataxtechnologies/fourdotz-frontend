...
@Component({
  selector: 'app-list-all-templates',
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './list-all-templates.component.html',
  styleUrl: './list-all-templates.component.css'
})
export class ListAllTemplatesComponent {
