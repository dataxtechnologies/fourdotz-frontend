...
@Component({
  selector: 'app-resident-viewprofile',
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './resident-viewprofile.component.html',
  styleUrl: './resident-viewprofile.component.css'
})
export class ResidentViewprofileComponent {
 /** UI STATES */
  editUpi = false;
