...
@Component({
  selector: 'app-book-amenities-byowner',
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './book-amenities-byowner.component.html',
  styleUrl: './book-amenities-byowner.component.css'
})
export class BookAmenitiesByownerComponent {
  ...
  submitBooking() {
    ...
    this.apiService.BookResourceinOwner<any>(payload).subscribe({
      ...
      error: (err: any) => {
        ...
        this.resetBookingForm(); // ← reset on HTTP error
      }
    });
  }
