...
@Component({
  selector: 'app-general-query-list',
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './general-query-list.component.html',
  styleUrl: './general-query-list.component.css'
})
export class GeneralQueryListComponent {
  ...
  openviewpayoutdetails(data: any) {
    this.Modal.open(ViewGeneralQueryDetailsComponent, {
      modal: {
  ...
  listPayoutRequests() {
    ...
    this.apiService.listAllRequestinSite<any>('website_ticket').subscribe({
      next: (res: any) => {
        if (res?.success) {
