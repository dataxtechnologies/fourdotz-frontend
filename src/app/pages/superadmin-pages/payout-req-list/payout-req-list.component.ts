...
@Component({
  selector: 'app-payout-req-list',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './payout-req-list.component.html',
  styleUrl: './payout-req-list.component.css'
})
export class PayoutReqListComponent implements OnInit {
  ...
  listPayoutRequests() {
    ...
    this.apiService.listpayoutrequestinSA<any>(this.userId).subscribe({
      next: (res: any) => {
        if (res?.success) {
