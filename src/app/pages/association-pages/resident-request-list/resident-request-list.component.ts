...
@Component({
  ...
  templateUrl: './resident-request-list.component.html',
  styleUrl: './resident-request-list.component.css'
})
export class ResidentRequestListComponent implements OnInit {
  Residentlist1: any;
  Residentlist2: any[] = [];
