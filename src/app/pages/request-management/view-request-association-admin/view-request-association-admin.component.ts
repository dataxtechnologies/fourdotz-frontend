...
@Component({
  selector: 'app-view-request-association-admin',
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './view-request-association-admin.component.html',
  styleUrl: './view-request-association-admin.component.css'
})
export class ViewRequestAssociationAdminComponent {
  RequestData: any
  ...
  ngOnInit(): void {
    ...
    if(this.loggedUserType === 'service_admin'){
      this.ListAllrequestinServiceAdminbyId(this.req_Id)
    }else{
 this.ListRequests(this.req_Id)
  ...
  ListRequests(data: any) {
    ...
    this.API.ListAllRequestinAssociationbyReqId<any>(data).subscribe({
      next: (res) => {
  ...
  ListAllrequestinServiceAdminbyId(data: any) {
    // this.tableLoading = true;

    this.API.ListAllrequestinServiceAdminbyId<any>(data).subscribe({
      next: (res) => {
