...
@Component({
  selector: 'app-qr-visitor-list',
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './qr-visitor-list.component.html',
  styleUrl: './qr-visitor-list.component.css'
})
export class QrVisitorListComponent {
  ...
  ListVisitorinGateKeeper() {
    this.apiService.OwnerLoginPreVisitor<any>('qr_code_entry').subscribe({
      next: (res: any) => {
        if (res?.success) {
